...
export class WidgetEditorViewStore extends BaseStore {
  ...
  @computed get filteredWidgets(): Array<WidgetModel> {
    return this.rootStore.widgetEditorDataStore.widgets.filter(widget => {
  ...
  private get asWriteable(): MakeWritable<WidgetEditorViewStore> {
    return (this as MakeWritable<WidgetEditorViewStore>);
  }
}

export default WidgetEditorViewStore;
